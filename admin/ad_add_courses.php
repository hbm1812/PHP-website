            ...
            <div class="body__content">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Courses's name" aria-label="Username" aria-describedby="basic-addon1" name="courses_name">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="courses_img">
                    </div>
                    <div class="text-danger">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Courses depcription" aria-label="Username" aria-describedby="basic-addon1" name="courses_depcription">
                    </div>
