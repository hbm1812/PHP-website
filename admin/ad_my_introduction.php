        ...
        <div class="body__content-margin">
            <div class="body__content">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="./ad_my_subjects.php?courses_id=<?= $_SESSION['courses_id'] ?>"><?php echo $_SESSION['courses_name']; ?></a></li>
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="./ad_edit_lesson.php?lesson_id=<?= $introduction['lesson_id'] ?>" class="btn btn-warning btn_1">Edit</a>
                        <form action="./ad_delete.php" method="post" id="formDelete-<?= $introduction['lesson_id'] ?>">
