...
if ($_GET['lesson_id']) {
    ...
    header("location:./ad_introduction.php");
}
...
<head>
    ...
    <link rel="stylesheet" href="./ad_assets/css/ad_lesson.css">
        ...
        <div class="body__content-margin">
            <div class="body__content">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="./ad_introduction.php?subjects_id=<?= $_SESSION['subjects_id'] ?>"><?php echo $_SESSION['courses_name'] . ' - ' . $_SESSION['subjects_name'] ?></a></li>
