...
$subjects = Auth::show_Subjects2($account_id);
...
<head>
    ...
    <link rel="stylesheet" href="./te_assets/css/te_my_subjects.css">
                ...
                ?>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo "Author: ".$get_Account_Username['username'] ?> </p>
                            <a href="./te_my_introduction.php?subjects_id=<?= $subject['subjects_id'] ?>" class="btn btn-primary btn_1" style="width:45%">Learn</a>
                            <a href="./te_edit_subjects.php?subjects_id=<?= $subject['subjects_id'] ?>" class="btn btn-warning btn_1" >Edit</a>
                            <form action="./te_delete.php" method="post" id="formDelete-<?= $subject['subjects_id'] ?>">
