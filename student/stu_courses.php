...
<head>
    ...
    <link rel="stylesheet" href="./stu_assets/css/stu_course.css">
                ...
                ?>
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="./stu_subject.php?courses_id=<?= $course['courses_id'] ?>" class="btn btn-primary btn_1">View more course</a>
