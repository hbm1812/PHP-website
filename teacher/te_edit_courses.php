...
<head>
  ...
  <link rel="stylesheet" href="./te_assets/css/te_edit_courses.css">
...
<body style=" background-color: rgb(224, 224, 224)">
    ...
    <div class=body__container>
        <div class="body__content-margin">
            ...
            <h2>Let's choose your course first</h2>
            <h4>All courses</h4>
                ...
                ?>
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="./te_edit_subjects.php?courses_id=<?= $course['courses_id'] ?>" class="btn btn-primary btn_1">View more course</a>
