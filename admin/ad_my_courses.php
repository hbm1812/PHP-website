...
<head>
    ...
    <link rel="stylesheet" href="./ad_assets/css/ad_courses.css">
    <link rel="stylesheet" href="./ad_assets/css/ad_my_courses.css">
                ...
                ?>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="./ad_my_subjects.php?courses_id=<?= $course['courses_id'] ?>" class="btn btn-primary btn_1">View more course</a>
                            <a href="./ad_edit_courses.php?courses_id=<?= $course['courses_id'] ?>" class="btn btn-warning btn_1" >Edit</a>
                            <form action="./ad_delete.php" method="post" id="formDelete-<?= $courses['courses_id'] ?>">
                                <input type="hidden" name="id_courses" value="<?= $course['courses_id'] ?>">
                                <button class="btn btn-danger btn-delete" id="<?= $course['courses_id'] ?>">Delete</button>
                            </form>
                        </div>
                    </div>
